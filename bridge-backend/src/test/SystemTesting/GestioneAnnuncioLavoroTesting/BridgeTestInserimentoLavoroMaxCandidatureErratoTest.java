...
import java.net.URL;
public class BridgeTestInserimentoLavoroMaxCandidatureErratoTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroMaxCandidatureErrato() {
    ...
    driver.findElement(By.id("maxCandidature")).click();
    driver.findElement(By.id("maxCandidature")).click();
    driver.findElement(By.id("maxCandidature")).sendKeys("9999999");
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).sendKeys("02:00");
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).sendKeys("10:00");
    ...
    driver.findElement(By.id("retribuzione")).sendKeys("4000");
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("3o c3oc 3ov 3v 3v 3v3 vo3n3i0fn3j3rifm");
    driver.findElement(By.cssSelector("input:nth-child(3)")).click();
    driver.findElement(By.cssSelector("input:nth-child(3)")).sendKeys("V");
    driver.findElement(By.id("infoUtili")).click();
    driver.findElement(By.id("infoUtili")).click();
    {
      WebElement element = driver.findElement(By.id("infoUtili"));
      Actions builder = new Actions(driver);
