...
import java.net.URL;
public class BridgeTestInserimentoLavoroNomeSedeErrata2Test {
  ...
  @Test
  public void bridgeTestInserimentoLavoroNomeSedeErrata2() {
    ...
    driver.findElement(By.cssSelector(".checkbox-container")).click();
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).sendKeys("10:05");
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).sendKeys("22:00");
    ...
    driver.findElement(By.id("nomeSede")).sendKeys("Sede#1");
    driver.findElement(By.id("infoUtili")).click();
    driver.findElement(By.id("infoUtili")).sendKeys("nvejv jv");
    ...
    driver.findElement(By.cssSelector("input:nth-child(5)")).sendKeys("10");
    ...
    driver.findElement(By.cssSelector("input:nth-child(9)")).sendKeys("33333");
