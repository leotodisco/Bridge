...
import java.net.URL;
public class BridgeTestInserimentoLavoroTitoloErratoTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroTitoloErrato() {
    ...
    driver.findElement(By.id("titolo")).sendKeys("Annuncio 88#");
    driver.findElement(By.id("titolo")).sendKeys("Annuncio 88#@");
    ...
    {
      WebElement element = driver.findElement(By.id("nomeAzienda"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
    driver.findElement(By.id("nomeAzienda")).sendKeys("Azienda");
    ...
    driver.findElement(By.cssSelector("input:nth-child(5)")).sendKeys("33");
    ...
    driver.findElement(By.cssSelector("input:nth-child(9)")).sendKeys("22222");
