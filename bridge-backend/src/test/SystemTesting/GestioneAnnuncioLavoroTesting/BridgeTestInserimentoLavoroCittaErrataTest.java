...
import java.net.URL;
public class BridgeTestInserimentoLavoroCittaErrataTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroCittaErrata() {
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("nvv9nvvnv4n04nv4n");
    ...
    driver.findElement(By.cssSelector("input:nth-child(7)")).sendKeys("S@l£rno");
