...
import java.net.URL;
public class BridgeTestInserimentoLavoroViaErrataTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroViaErrata() {
    driver.get("http://localhost:5174/");
    driver.manage().window().setSize(new Dimension(1680, 966));
    ...
    driver.findElement(By.id("titolo")).sendKeys("Annuncio di Test");
    driver.findElement(By.id("titolo")).click();
    driver.findElement(By.id("titolo")).click();
    {
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("Per info ");
    driver.findElement(By.id("infoUtili")).click();
    driver.findElement(By.id("infoUtili")).click();
    {
    ...
    driver.findElement(By.id("infoUtili")).click();
    driver.findElement(By.id("infoUtili")).sendKeys("Per info, contattare: email@example.com");
    driver.findElement(By.cssSelector("input:nth-child(3)")).click();
    driver.findElement(By.cssSelector("input:nth-child(3)")).sendKeys("Vi@");
