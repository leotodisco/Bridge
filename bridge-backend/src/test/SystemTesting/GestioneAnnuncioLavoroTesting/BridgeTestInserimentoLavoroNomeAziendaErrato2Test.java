...
import java.net.URL;
public class BridgeTestInserimentoLavoroNomeAziendaErrato2Test {
  ...
  @Test
  public void bridgeTestInserimentoLavoroNomeAziendaErrato2() {
    ...
    driver.findElement(By.id("nomeAzienda")).sendKeys("N0me *ziend-");
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("w cjw cowc oe vo2 v");
