...
import java.net.URL;
public class BridgeTestInserimentoLavoroTipoContrattoErratoTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroTipoContrattoErrato() {
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).sendKeys("22:02");
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).sendKeys("22:22");
    ...
    driver.findElement(By.id("retribuzione")).sendKeys("22000");
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("nwococ c ");
