...
import java.net.URL;
public class BridgeTestInserimentoLavoroRetribuzioneErrataTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroRetribuzioneErrata() {
    ...
    driver.findElement(By.id("posizione")).sendKeys("Commesso per negozio di Abbigliamento");
    driver.findElement(By.id("nomeAzienda")).click();
    driver.findElement(By.id("titolo")).click();
    driver.findElement(By.id("titolo")).click();
    {
      WebElement element = driver.findElement(By.id("titolo"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
    driver.findElement(By.id("titolo")).click();
    driver.findElement(By.id("titolo")).click();
    driver.findElement(By.id("titolo")).sendKeys("Cercasi Commesso/a");
    driver.findElement(By.id("nomeAzienda")).click();
    driver.findElement(By.id("nomeAzienda")).sendKeys("Zara");
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).sendKeys("10:00");
    ...
    driver.findElement(By.id("tipoContratto")).click();
    {
      ...
      dropdown.findElement(By.xpath("//option[. = 'Contratto a Progetto']")).click();
    }
    ...
    driver.findElement(By.id("retribuzione")).click();
    driver.findElement(By.id("retribuzione")).sendKeys("15000.00");
    driver.findElement(By.id("retribuzione")).click();
    driver.findElement(By.id("retribuzione")).sendKeys("1509999999999999900.00");
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("ocncnocnon");
