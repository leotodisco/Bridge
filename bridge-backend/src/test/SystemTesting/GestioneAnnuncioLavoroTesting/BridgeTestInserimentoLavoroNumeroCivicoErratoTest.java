...
import java.net.URL;
public class BridgeTestInserimentoLavoroNumeroCivicoErratoTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroNumeroCivicoErrato() {
    ...
    driver.findElement(By.cssSelector("input:nth-child(5)")).sendKeys("12234");
