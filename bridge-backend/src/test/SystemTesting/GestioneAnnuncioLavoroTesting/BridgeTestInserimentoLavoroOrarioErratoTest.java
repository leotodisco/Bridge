...
import java.net.URL;
public class BridgeTestInserimentoLavoroOrarioErratoTest {
  ...
  @Test
  public void bridgeTestInserimentoLavoroOrarioErrato() {
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails")).click();
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("p3p3pn3p3np");
    ...
    driver.findElement(By.cssSelector("input:nth-child(5)")).sendKeys("22");
    driver.findElement(By.cssSelector("button:nth-child(12)")).click();
    driver.findElement(By.cssSelector(".orari-row")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(1)")).sendKeys("01:03");
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).click();
    driver.findElement(By.cssSelector(".inlineCityDetails > input:nth-child(2)")).sendKeys("04:02");
    driver.findElement(By.cssSelector("button:nth-child(12)")).click();
  }
}
