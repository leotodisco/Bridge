...
import java.net.URL;
public class BridgeTestInserimentoLavoroPosizioneLavorativaErrata2Test {
  ...
  @Test
  public void bridgeTestInserimentoLavoroPosizioneLavorativaErrata2() {
    ...
    driver.findElement(By.id("posizione")).click();
    driver.findElement(By.id("posizione")).click();
    driver.findElement(By.id("posizione")).sendKeys("Svil*ppatore Softwa*e");
    ...
    driver.findElement(By.id("infoUtili")).sendKeys("2on2oicn2ocn2co2n");
