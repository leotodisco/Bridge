...
import java.net.URL;
public class BridgeTestNomeRifugiatoFormatoErratoTest {
  ...
  @Test
  public void bridgeTestNomeRifugiatoFormatoErrato() {
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(7)")).sendKeys("Falegnameria, Lavorar in team");
    ...
    driver.findElement(By.cssSelector(".password-field:nth-child(12) > .formEditText")).sendKeys("Prova123!");
