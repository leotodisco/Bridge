...
import java.net.URL;
public class TestAllRifugiatoFormatoCorrettoTest {
  ...
  @Test
  public void testAllRifugiatoFormatoCorretto() {
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(6)")).sendKeys("Francese Inglese Italiano");
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(10)")).sendKeys("mariozurolo@gmail.com");
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(13)")).sendKeys("C:\\fakepath\\prova.jpg");
