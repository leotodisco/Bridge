...
import java.net.URL;
public class TestTitoloDiStudioRifugiatoFormatoErratoTest {
  ...
  @Test
  public void testTitoloDiStudioRifugiatoFormatoErrato() {
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(6)")).sendKeys("Francese Italiano Inglese");
    driver.findElement(By.cssSelector(".formEditText:nth-child(7)")).sendKeys("Falegnameria, Lavoro in team");
