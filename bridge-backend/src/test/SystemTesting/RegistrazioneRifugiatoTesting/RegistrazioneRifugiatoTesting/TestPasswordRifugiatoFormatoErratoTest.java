...
import java.net.URL;
public class TestPasswordRifugiatoFormatoErratoTest {
  ...
  @Test
  public void testPasswordRifugiatoFormatoErrato() {
    driver.get("http://localhost:5174/crea-utente");
    ...
    driver.findElement(By.cssSelector(".showPW")).click();
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(10)")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".formEditText:nth-child(10)"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
    driver.findElement(By.cssSelector(".formEditText:nth-child(10)")).click();
