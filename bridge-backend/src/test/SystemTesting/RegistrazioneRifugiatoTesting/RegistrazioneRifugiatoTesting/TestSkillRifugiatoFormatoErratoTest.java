...
import java.net.URL;
public class TestSkillRifugiatoFormatoErratoTest {
  ...
  @Test
  public void testSkillRifugiatoFormatoErrato() {
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(13)")).sendKeys("C:\\fakepath\\calcutta.jpg");
