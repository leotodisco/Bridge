...
public class TC2Test {
  ...
  public void tC2() {
    ...
    driver.findElement(By.cssSelector(".formEditText:nth-child(4)")).sendKeys("Consulenza per documenti e permessi di soggiorno");
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(2)")).sendKeys("23:00");
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(10)")).click();
