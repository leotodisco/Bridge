...
public class TC1Test {
  ...
  public void tC1() {
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(2)")).sendKeys("12:43");
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(3)")).sendKeys("23:42");
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(13) > .formEditText:nth-child(2)")).sendKeys("12");
