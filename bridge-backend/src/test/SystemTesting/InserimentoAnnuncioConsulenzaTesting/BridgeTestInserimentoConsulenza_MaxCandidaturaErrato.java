...
public class TC10Test {
  ...
  public void tC10() {
    ...
    driver.findElement(By.cssSelector(".submenu > li:nth-child(2)")).click();
    driver.findElement(By.linkText("Consulenze")).click();
    {
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(3)")).sendKeys("14:00");
    ...
    driver.findElement(By.cssSelector(".candidatureInput")).sendKeys("500");
