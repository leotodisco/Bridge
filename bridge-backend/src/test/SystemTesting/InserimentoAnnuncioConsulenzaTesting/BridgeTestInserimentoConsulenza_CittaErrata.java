...
public class TC7Test {
  ...
  public void tC7() {
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(3)")).sendKeys("14:02");
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(1) > input:nth-child(3)")).sendKeys("14:23");
    ...
    driver.findElement(By.cssSelector(".inlineCityDetails:nth-child(14) > .formEditText:nth-child(1)")).sendKeys("Roma (RM)");
